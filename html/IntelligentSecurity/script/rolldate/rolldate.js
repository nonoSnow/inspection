...
(function (global, factory) {
  ...
  function Rolldate() {
      ...
      _this.extend(config);
      // if (nowElement != config.el) {
      //   _this.hide();
      // }
      nowElement = config.el;
      if (config.el) {
          el = _this.$(config.el);
  ...
  Rolldate.prototype = {
      ...
      createUI: function createUI() {
          ...
          // '+ lang.title +'\n
          var $html = '';
          $html = '<div class="rolldate-panel">\n                <header>\n      <span class="rolldate-btn rolldate-cancel">' + lang.cancel + '</span>\n   <span class="rolldate-btn rolldate-confirm" id="rolldate-confirm">' + lang.confirm + '</span>\n                </header>\n                <section class="rolldate-content">\n                    <div class="rolldate-dim mask-top"></div>\n                    <div class="rolldate-dim mask-bottom"></div>\n                    <div class="rolldate-wrapper">\n                        ' + ul + '\n                    </div>\n                </section>\n            </div>';

          var box = document.createElement("div");

          // var $html = '<div class="rolldate-panel">\n                <section class="rolldate-content">\n                    <div class="rolldate-dim mask-top"></div>\n                    <div class="rolldate-dim mask-bottom"></div>\n                    <div class="rolldate-wrapper">\n                        ' + ul + '\n                    </div>\n                </section>\n            </div>',
          ...
          document.getElementById('select-time-cont').appendChild(box);
          ...
          var _loop = function _loop(_i) {
              ...
              that.on('scrollEnd', function () {
                  ...
                  document.getElementById(config.el.substring(1, config.el.length)).value = date;
      ...
      event: function event() {
        var _this = this;
        document.getElementById('rolldate-confirm').addEventListener('click', function() {
          _this.hide();
        });
          // var _this = this,
      ...
      destroy: function destroy(flag) {
          ...
          document.getElementById("select-time-cont").removeChild(el);
      },
