                    ...
                    db.selectSql({
                        ...
                        if( ret.status ){
                          if(ret.data.length > 0){
                            ...
                            this.taskCountSum.launchNumber = 0;
                            this.taskCountSum.handledNumber =  0;
                            this.taskCountPie = eData;
                            this.taskCountSum.waitNumber =ret.data.length;
                            this.initChart();

                          }else {
                            this.taskCountPie = eData;
                            this.taskCountSum.handledNumber =  0;
                            this.taskCountSum.waitNumber =0;
                            this.taskCountSum.waitNumber =ret.data.length;
                            this.initChart();
                          }
                        }
