(function() {
    ...
    Mdate.prototype = {
        ...
        createDateUi: function() {
            var str = "" + '<section class="getDateBg"></section>' + '<section class="getDateBox" id="getDateBox">' + '<div class="choiceDateTitle">' + '<button id="dateCancel" style="color:#999999">取消</button>' + '<button>请选择时间</button>' +'<button id="dateSure" class="fr" style="color:#1890FF">确定</button>' + "</div>" + '<div class="dateContent">' + '<div class="checkeDate"></div>' + '<div id="yearwrapper">' + '<ul id="yearUl"></ul>' + "</div>" + '<div id="monthwrapper">' + '<ul id="monthUl"></ul>' + "</div>" + '<div id="daywrapper">' + '<ul id="dayUl"></ul>' + "</div>" + "</div>"+ '<div class="choiceDateTitleTOday">今天</div>' + "</section>";
