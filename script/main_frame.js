var vueInitData = {
    ...
    hasTaskListPower: true, //是否显示任务列表
    isShowClaimBox: true, //是否显示认领
...
function fnInVue() {
    window.MainVue = new Vue({
        ...
        methods: {
              ...
              var _this = this;
                fnGet('services/app/Home/GetLoginInfo', {}, false, function(ret, err){
                    ...
                    if (ret && ret.success) {
                        ...
                        if (ret.result.tenantInfo.tenantIdentifier != "" && ret.result.tenantInfo.tenantIdentifier == "cdzls") {
                            ...
                            _this.addNewScriptToHtml();  //成都这边不要删除调用  20200819 zxf
                    ...
                    if (ret) {
                        if (ret.success) {
                            if (ret.result != null) {
                                ...
                                _this.getTenantInfo(); //查询当前租户信息 zxf 20200729
                            }
                        }
                    }
                });
            ...
            addNewScriptToHtml:function() {  //成都这边不需要
